  ...
  return (
    <VoteProvider>
      <BrowserRouter>
        ...
        {/* Header Navigation */}
        <nav className="fixed top-0 left-0 w-full bg-blue-400 text-white p-4 flex justify-between items-center z-20 text-lg">
          {/* Logo */}
          ...
          {/* Navigation Links */}
          <div
            className={`absolute top-16 left-0 w-full bg-blue-400 md:static md:w-auto md:flex md:items-center z-10 ${
        ...
        {/* Footer */}
        <footer className="fixed bottom-0 left-0 w-full bg-blue-400 text-white py-4 text-center z-20">
